...
--server <url>    # Shipyard Server URL (default: http://localhost:15678)
```
...
- `--endpoint <url>`: Server endpoint URL (e.g., http://localhost:15678)
...
shipyard-cli login --endpoint http://localhost:15678
...
Please open the following URL in your browser to authorize:
  http://localhost:15678/auth/device?session_id=xxx
