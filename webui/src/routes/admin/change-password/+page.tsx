...
export default function SecuritySettingsPage(): JSX.Element {
  ...
  return (
    <div class="container mx-auto p-6 space-y-8">
      {/* Header */}
      <div>
        <h1 class="text-3xl font-bold text-base-content">Security Settings</h1>
        <p class="text-base-content/70 mt-2">Manage your password and two-factor authentication.</p>
      </div>
